...
@Data
@Configuration
@MapperScan(basePackages = "com.lee.mapper.local", sqlSessionFactoryRef = "localSqlSessionFactory")
@ConfigurationProperties(prefix = "local.datasource")
public class LocalDruidConfig {

	private Logger logger = LoggerFactory.getLogger(LocalDruidConfig.class);
	...
	public ServletRegistrationBean druidServlet() {
		...
		reg.addUrlMappings("/druid/local/*");
	...
	public SqlSessionFactory sqlSessionFactoryBean() throws Exception {
		...
		sqlSessionFactoryBean.setMapperLocations(new PathMatchingResourcePatternResolver()
				.getResources("classpath*:mappers/local/*Mapper.xml"));
	...
	@Bean("localDataSourceTransactionManager")
	@Primary
